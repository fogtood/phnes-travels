const Policies = () => {
  return (
    <div className="container mx-auto px-6 pt-20 pb-40">
      <section>
        <h1 className="mb-18 text-center text-xl font-bold uppercase sm:text-2xl md:text-3xl lg:text-4xl">
          Privacy Policy
        </h1>
        <h2 className="text-lg font-bold sm:text-xl lg:text-2xl">
          Privacy Policy for Catalyst Global Education Marketplace, LLC d.b.a.
        </h2>

        <HeaderText header={"Catalyst GEM & CatalystGEM"}>
          At Catalyst GEM, accessible from www.catalystgem.io, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Catalyst GEM and how we use it. If you have additional questions or
          ...
          information that they shared and/or collect in Catalyst GEM. This
          policy is not applicable to any information collected offline or via
          channels other than this website.
        </HeaderText>

        <HeaderText header={"Consent"}>
          By using our website, you hereby consent to our Privacy Policy and
          agree to its terms.
        </HeaderText>

        <HeaderText header={"Information we collect"}>
        ...
        <HeaderText header={"How we use your information"}>
        ...
        <HeaderText header={"Log Files"}>
          Catalyst GEM follows a standard procedure of using log files. These
        ...
        <HeaderText header={"Cookies and Web Beacons"}>
          Like any other website, Catalyst GEM uses ‘cookies’. These cookies are
        ...
        <HeaderText header={"Advertising Partners Privacy Policies"}>
          You may consult this list to find the Privacy Policy for each of the
          advertising partners of Catalyst GEM. Third-party ad servers or ad
          ...
          on Catalyst GEM, which are sent directly to users’ browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that Catalyst GEM has no
          access to or control over these cookies that are used by third-party
          advertisers.
        </HeaderText>

        <HeaderText header={"Third Party Privacy Policies"}>
        ...
        <HeaderText header={"GDPR Data Protection Rights"}>
        ...
        <HeaderText header={"Children’s Information"}>
          Another part of our priority is adding protection for children while
          using the internet. We encourage parents and guardians to observe,
          participate in, and/or monitor and guide their online activity.
          Catalyst GEM does not knowingly collect any Personal Identifiable
      ...
      <section className="mt-40">
        ...
        <HeaderText header={"Terms and Conditions"}>
          These terms and conditions outline the rules and regulations for using
          Catalyst Global Education Marketplace, LLC, doing business as Catalyst
          GEM & Catalyst GEM Website, located at www.catalystgem.io. By
          ...
          stated on this page, please discontinue use of Catalyst GEM. The
          ...
          “Our,” and “Us” refer to Catalyst GEM. “Party,” “Parties,” or “Us”
          refers to both the Client and the Company. All terms refer to the
          offer, acceptance, and consideration of payment necessary to provide
          our services to the Client in the most appropriate manner to meet the
          Client’s needs, in accordance with and subject to the prevailing laws
          of the United States. Any use of the above terminology or other words
          in the singular, plural, capitalization, and/or he/she/they pronouns
          are taken as interchangeable and therefore refer to the same.
        </HeaderText>

        <HeaderText header={"Cookies"}>
          We employ the use of cookies. By accessing Catalyst GEM, you agreed to
          use cookies in agreement with the Catalyst GEM Privacy Policy. Most
        ...
        <HeaderText header={"License"}>
          Unless otherwise stated, Catalyst GEM and/or its licensors own the
          intellectual property rights for all material on Catalyst GEM. All
          intellectual property rights are reserved. You may access this from
          Catalyst GEM for your own personal use subjected to restrictions set
          in these terms and conditions. You must not: Republish material from
          Catalyst GEM Sell, rent or sub-license material from Catalyst GEM
          Reproduce, duplicate or copy material from Catalyst GEM Redistribute
          content from Catalyst GEM This Agreement shall begin on the date
          ...
          Catalyst GEM does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Catalyst GEM, its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Catalyst GEM
          shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website. Catalyst
          GEM reserves the right to monitor all Comments and to remove any
          ...
          commercial activities or unlawful activity. You hereby grant Catalyst
          GEM a non-exclusive license to use, reproduce, edit and authorize
          others to use, reproduce and edit any of your Comments in any and all
          forms, formats or media.
        </HeaderText>

        <HeaderText header={"Hyperlinking to our Content"}>
          ...
          absence of Catalyst GEM; and (d) the link is in the context of general
          ...
          must inform us by sending an e-mail to Catalyst GEM LLC. Please
          ...
          linking party’s site. No use of Catalyst GEM LLC’s logo or other
          artwork will be allowed for linking absent a trademark license
          agreement.
        </HeaderText>

        <HeaderText header={"iFrames"}>
          Without prior approval and written permission, you may not create
          frames around our Webpages that alter in any way the visual
          presentation or appearance of our Website
        </HeaderText>

        <HeaderText header={"Content Liability"}>
        ...
        <HeaderText header={"Your Privacy"}>
          Please read Privacy Policy
        </HeaderText>

        <HeaderText header={"Reservation of Rights"}>
        ...
        <HeaderText header={"Removal of links from our website"}>
...
const HeaderText = ({ header, children }) => {
  return (
    <div className="my-12 space-y-4">
      <h2 className="text-lg font-bold sm:text-xl lg:text-2xl">{header}</h2>
